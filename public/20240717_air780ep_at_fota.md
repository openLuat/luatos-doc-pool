...
![image-20240719115057101](image/image-20240719115057101.png)

4. 如果配置“升级全部设备”选项为“是”，则无需配置IMEI，按照上述内容配置即可。如果选择“否”，还需添加IMEI，如下图所示。

![image-20240719115427277](image/image-20240719115427277.png)
...
![image-20240719120249723](image/image-20240719120249723.png)
...
![image-20240719121533301](image/image-20240719121533301.png)
...
![image-20240719121750007](image/image-20240719121750007.png)
...
![image-20240719123348464](image/image-20240719123348464.png)
...
![image-20240719124343704](image/image-20240719124343704.png)
...
![image-20240719130326634](image/image-20240719130326634.png)

下载生成的差分文件

![image-20240717191819446](image/image-20240717191819446.png)

- 本次我们从V1006升级到V1007需要准备各自的bin远程升级文件，上传完成后等待差分完成，下载得到的差分文件，这里将名字改为**dfota_final_AirM2M_AirM2M_V1007.bin**。
...
![image-20240719131149930](image/image-20240719131149930.png)
