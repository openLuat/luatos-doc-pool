...
![image-20240724110431471](image/image-20240724110431471.png)
...
![image-20240725132809885](C:/Users/HP/AppData/Roaming/Typora/typora-user-images/image-20240725132809885.png)

![image-20240725163008585](image/image-20240725163008585.png)

## CSDK开发

0. 根据满足需求编译固件，CSDK编译说明可跳转至[CSDK开发资料](https://gitee.com/openLuat/luatos-doc-pool/tree/master/doc/CSDK开发资料/应用开发指南)
1. 得到固件之后，仿照AT开发的固件烧录教程进行烧录即可
